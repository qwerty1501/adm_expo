# Generated by Django 3.2.9 on 2023-06-13 07:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default='pbkdf2_sha256$260000$TodrvWehZ33rlgUDAsq8LB$ofFXEHljBZLAYUg+Ne0AiG0dbiP0ksLpFlZ6lhBoWVI=', max_length=128, verbose_name='Пароль')),
                ('name', models.CharField(blank=True, max_length=300, null=True, verbose_name='Имя')),
                ('surname', models.CharField(blank=True, max_length=300, null=True, verbose_name='Фамилия')),
